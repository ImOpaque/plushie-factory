...
export type CentrifugePlushieStationProceduralProps = {
  onPlushieClick: () => void;
};
...
/**
 * Built-in procedural machine (fallback when `machine.glb` is disabled or fails to load).
 */
export function CentrifugePlushieStationProcedural({
  onPlushieClick,
}: CentrifugePlushieStationProceduralProps) {
